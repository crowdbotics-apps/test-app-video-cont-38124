...
## Project Structure
    ...
    ├── test_app_video_cont_38124  # Django project configurations
...
1. Clone this repo and `cd test_app_video_cont_38124`
...
2. Clone this repo and `cd test_app_video_cont_38124`
